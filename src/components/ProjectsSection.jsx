...
const ProjectCard = ({project, index, onOpenProject, t, isDark}) => {
    ...
    return (
        <MotionBox
            ...
            whileHover={{
                scale: 1.02,
                y: -4,
                borderColor: isDark ? "#4FD1C5" : "#81E6D9",
                boxShadow: isDark
